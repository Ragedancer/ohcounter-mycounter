...
class Increment extends React.Component {
    ...
    increment = (newLifePoints,  newHitPoints) =>{
        newLifePoints += newHitPoints;
        // send back dat from child to parent or setter
    ...
    render(){
        return (
            <div className={"increment-icon"}>
                ...
                <IconButton onClick={() => this.increment(this.props.lifePoints, this.props.hitPoints)}>
